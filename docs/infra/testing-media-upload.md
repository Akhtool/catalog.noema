...
1. Откройте `http://crusty.catlg.ru:3000/login`
2. Войдите с учётными данными пользователя, у которого есть доступ к бизнесу
3. Должен открыться каталог бизнеса на `http://crusty.catlg.ru:3000/` в owner/admin режиме

### Шаг 3: Переход на страницу редактирования бизнеса

1. Откройте `http://crusty.catlg.ru:3000/admin/business`
