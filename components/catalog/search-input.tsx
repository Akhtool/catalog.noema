...
export function SearchInput({ categories, products }: SearchInputProps) {
  ...
  return (
    <>
      <div className="bg-white rounded-2xl shadow-card p-2 flex items-center gap-2 mb-6">
        <div className="flex-1 relative">
          ...
          <Input
            ...
            className="w-full bg-gray-50 border-none rounded-xl pl-12 py-3.5 text-sm font-medium focus:ring-2 focus:ring-brand-yellow focus:bg-white transition-all placeholder-gray-400"
          />
        </div>
        <Button
          size="icon"
